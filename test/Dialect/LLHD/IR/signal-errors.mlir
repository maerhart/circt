...
hw.module @check_illegal_prb(%sig : !hw.inout<i1>) {
...
hw.module @check_illegal_drv(%sig : !hw.inout<i1>) {
  %c = hw.constant 0 : i32
...
hw.module @check_unique_sig_names() {
  %cI1 = hw.constant 0 : i1
...
hw.module @check_unique_sig_names2() {
  %cI1 = hw.constant 0 : i1
