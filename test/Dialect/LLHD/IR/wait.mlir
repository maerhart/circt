...
llhd.proc @check_wait_2 (%arg0 : !hw.inout<i64>, %arg1 : !hw.inout<i1>) -> () {
  ...
  "llhd.wait"(%arg0, %arg1, %arg1) [^bb1] {operand_segment_sizes=array<i32: 2,0,1>} : (!hw.inout<i64>, !hw.inout<i1>, !hw.inout<i1>) -> ()
...
llhd.proc @check_wait_3 (%arg0 : !hw.inout<i64>, %arg1 : !hw.inout<i1>) -> () {
  ...
  "llhd.wait"(%arg0, %arg1, %time, %arg1, %arg0) [^bb1] {operand_segment_sizes=array<i32: 2,1,2>} : (!hw.inout<i64>, !hw.inout<i1>, !llhd.time, !hw.inout<i1>, !hw.inout<i64>) -> ()
