...
func.func @checkPrb(%arg0 : !hw.inout<i1>, %arg1 : !hw.inout<i64>, %arg2 : !hw.inout<!hw.array<3xi8>>, %arg3 : !hw.inout<!hw.struct<foo: i1, bar: i2, baz: i4>>) {
  ...
  // CHECK-NEXT: %{{.*}} = llhd.prb %arg2 : !hw.inout<!hw.array<3xi8>>
  %2 = llhd.prb %arg2 : !hw.inout<!hw.array<3xi8>>
  // CHECK-NEXT: %{{.*}} = llhd.prb %arg3 : !hw.inout<!hw.struct<foo: i1, bar: i2, baz: i4>>
  %3 = llhd.prb %arg3 : !hw.inout<!hw.struct<foo: i1, bar: i2, baz: i4>>
...
func.func @checkDrv(%arg0 : !hw.inout<i1>, %arg1 : !hw.inout<i64>, %arg2 : i1,
    %arg3 : i64, %arg4 : !llhd.time, %arg5 : !hw.inout<!hw.array<3xi8>>,
    %arg6 : !hw.inout<!hw.struct<foo: i1, bar: i2, baz: i4>>,
  ...
  // CHECK-NEXT: llhd.drv %arg5, %arg7 after %arg4 : !hw.inout<!hw.array<3xi8>>
  llhd.drv %arg5, %arg7 after %arg4 : !hw.inout<!hw.array<3xi8>>
  // CHECK-NEXT: llhd.drv %arg6, %arg8 after %arg4 : !hw.inout<!hw.struct<foo: i1, bar: i2, baz: i4>>
  llhd.drv %arg6, %arg8 after %arg4 : !hw.inout<!hw.struct<foo: i1, bar: i2, baz: i4>>
