...
// CHECK-LABEL:   llhd.process @check_simple()
...
// CHECK-LABEL:   llhd.process @pointer_returned_from_call()
// CHECK:           %[[ALLSET:.*]] = hw.constant -1 : i32
...
// CHECK:           llhd.halt
// CHECK:         }
llhd.process @pointer_returned_from_call() {
  %allset = hw.constant -1 : i32
  %cond = hw.constant 1 : i1
...
// CHECK-LABEL:   llhd.process @pointer_passed_to_function()
// CHECK:           %[[ALLSET:.*]] = hw.constant -1 : i32
// CHECK:           %[[VAL_0:.*]] = hw.constant true
...
// CHECK:           llhd.halt
// CHECK:         }
llhd.process @pointer_passed_to_function() {
  %allset = hw.constant -1 : i32
  %cond = hw.constant 1 : i1
  %c5 = hw.constant 5 : i32
  %ptr = llhd.var %c5 : i32
...
// CHECK-LABEL:   llhd.process @pointer_block_argument()
// CHECK:           %[[ALLSET:.*]] = hw.constant -1 : i32
// CHECK:           %[[VAL_0:.*]] = hw.constant 5 : i32
// CHECK:           %[[VAL_1:.*]] = hw.constant true
...
// CHECK:           llhd.halt
// CHECK:         }
llhd.process @pointer_block_argument() {
  %allset = hw.constant -1 : i32
  %c5 = hw.constant 5 : i32
  %cond = hw.constant 1 : i1
  %ptr = llhd.var %c5 : i32
...
// CHECK-LABEL:   llhd.process @two_block_arguments()
// CHECK:           %[[ALLSET:.*]] = hw.constant -1 : i32
// CHECK:           %[[VAL_0:.*]] = hw.constant 5 : i32
// CHECK:           %[[VAL_1:.*]] = hw.constant true
// CHECK:           cf.cond_br %[[VAL_1]], ^bb1, ^bb2
...
// CHECK:           llhd.halt
// CHECK:         }
llhd.process @two_block_arguments() {
  %allset = hw.constant -1 : i32
  %c5 = hw.constant 5 : i32
  %cond = hw.constant 1 : i1
  %ptr = llhd.var %c5 : i32
...
// CHECK-LABEL:   llhd.process @multiple_store_one_block()
// CHECK:           %[[ALLSET:.*]] = hw.constant -1 : i32
// CHECK:           %[[VAL_0:.*]] = hw.constant 5 : i32
// CHECK:           %[[VAL_1:.*]] = hw.constant true
...
// CHECK:           llhd.halt
// CHECK:         }
llhd.process @multiple_store_one_block() {
  %allset = hw.constant -1 : i32
  %c5 = hw.constant 5 : i32
  %cond = hw.constant 1 : i1
  %ptr = llhd.var %c5 : i32
...
// CHECK-LABEL:   llhd.process @more_complicated()
