...
// CHECK:           %[[VAL_10:.*]] = seq.compreg sym @fifo_count  %[[VAL_11:.*]] clock %[[CLOCK]] reset %[[VAL_1]], %[[VAL_9]]  : i2
// CHECK:           %[[VAL_12:.*]] = seq.hlmem @fifo_mem %[[CLOCK]], %[[VAL_1]] : <3xi32>
// CHECK:           %[[VAL_13:.*]] = seq.compreg sym @fifo_rd_addr  %[[VAL_14:.*]] clock %[[CLOCK]] reset %[[VAL_1]], %[[VAL_9]]  : i2
// CHECK:           %[[VAL_15:.*]] = seq.compreg sym @fifo_wr_addr  %[[VAL_16:.*]] clock %[[CLOCK]] reset %[[VAL_1]], %[[VAL_9]]  : i2
...
// CHECK:           %[[VAL_13:.*]] = seq.compreg sym @fifo_count  %[[VAL_14:.*]] clock %[[CLOCK]] reset %[[VAL_1]], %[[VAL_11]]  : i3
// CHECK:           %[[VAL_15:.*]] = seq.hlmem @fifo_mem %[[CLOCK]], %[[VAL_1]] : <4xi32>
// CHECK:           %[[VAL_16:.*]] = seq.compreg sym @fifo_rd_addr  %[[VAL_17:.*]] clock %[[CLOCK]] reset %[[VAL_1]], %[[VAL_6]]  : i2
// CHECK:           %[[VAL_18:.*]] = seq.compreg sym @fifo_wr_addr  %[[VAL_19:.*]] clock %[[CLOCK]] reset %[[VAL_1]], %[[VAL_6]]  : i2
