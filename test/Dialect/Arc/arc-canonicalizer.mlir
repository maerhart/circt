...
// CHECK-LABEL: func.func @ConcatOfBitwiseOfExtract
func.func @ConcatOfBitwiseOfExtract(%arg0: i4, %arg1: i1, %arg2: i1, %arg3: i1, %arg4: i1) -> i4 {
  // CHECK-NEXT: %c-1_i4 = hw.constant -1 : i4
  // CHECK-NEXT: [[V0:%.+]] = comb.xor %arg0, %c-1_i4 : i4
  // CHECK-NEXT: return [[V0]]
  %true = hw.constant true
  %0 = comb.extract %arg0 from 3 : (i4) -> i1
  %1 = comb.extract %arg0 from 2 : (i4) -> i1
  %2 = comb.extract %arg0 from 1 : (i4) -> i1
  %3 = comb.extract %arg0 from 0 : (i4) -> i1
  %4 = comb.xor %0, %arg1 : i1
  %5 = comb.xor %1, %arg2 : i1
  %6 = comb.xor %2, %arg3 : i1
  %7 = comb.xor %3, %arg4 : i1
  %8 = comb.concat %4, %5, %6, %7 : i1, i1, i1, i1
  %9 = comb.concat %arg1, %arg2, %arg3, %arg4 : i1, i1, i1, i1
  %10 = comb.and %8, %9 : i4
  func.return %10 : i4
}

// Other pattern ideas:
// extract(bitwise(concat))
// concat(bitwise(extract))
...
func.func @concatPullUp(%arg0: i2, %arg1: i2, %arg2: i2, %arg3: i2, %arg4: i2, %arg5: i2) -> (i8, i8, i8) {
  ...
  // CHECK-NEXT: %c95_i8 = hw.constant 95 : i8
  ...
  // CHECK-NEXT: [[V2:%.+]] = comb.concat %arg4, %arg5 : i2, i2
  // CHECK-NEXT: [[V3:%.+]] = comb.xor [[V2]], %c-1_i4 : i4
  // CHECK-NEXT: [[V4:%.+]] = comb.concat %arg0, [[V3]], %arg3 : i2, i4, i2
  %5 = comb.xor %arg4, %c-1_i2 : i2
  %6 = comb.xor %arg5, %c-1_i2 : i2
  %7 = comb.concat %arg0, %5, %6, %arg3 : i2, i2, i2, i2

  // CHECK-NEXT: [[V5:%.+]] = comb.concat %arg0, %arg1, %arg2, %arg3 : i2, i2, i2, i2
  // CHECK-NEXT: [[V6:%.+]] = comb.and [[V5]], %c95_i8 : i8
  ...
  // CHECK-NEXT: return [[V1]], [[V4]], [[V6]] : i8, i8, i8
