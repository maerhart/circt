...
// CHECK-LABEL: func @integerOperations
func.func @integerOperations() {
  ...
  // CHECK-NEXT: smt.int.sub [[V0]], [[V0]], [[V0]] {smt.some_attr}
  %4 = smt.int.sub %0, %0, %0 {smt.some_attr}
  ...
  // CHECK-NEXT: smt.int.rem [[V0]], [[V0]] {smt.some_attr}
  %7 = smt.int.rem %0, %0 {smt.some_attr}
  // CHECK-NEXT: smt.int.pow [[V0]], [[V0]] {smt.some_attr}
  %8 = smt.int.pow %0, %0 {smt.some_attr}
