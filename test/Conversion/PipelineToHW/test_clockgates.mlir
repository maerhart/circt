...
// CHECK:           %[[VAL_8:.*]] = seq.compreg sym @p0_stage0_reg0 %[[VAL_5]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_9:.*]] = seq.compreg sym @p0_stage0_reg1 %[[VAL_0]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_10:.*]] = hw.constant false
// CHECK:           %[[VAL_11:.*]] = seq.compreg sym @p0_stage1_enable  %[[VAL_2]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_10]]  : i1
...
// CGATE:           %[[VAL_11:.*]] = seq.compreg sym @p0_stage0_reg0 %[[VAL_5]] clock %[[VAL_10]] : i32
// CGATE:           %[[VAL_12:.*]] = seq.compreg sym @p0_stage0_reg1 %[[VAL_0]] clock %[[VAL_8]] : i32
// CGATE:           %[[VAL_13:.*]] = hw.constant false
// CGATE:           %[[VAL_14:.*]] = seq.compreg sym @p0_stage1_enable  %[[VAL_2]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_13]]  : i1
