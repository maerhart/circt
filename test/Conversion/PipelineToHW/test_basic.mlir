...
// CHECK:           %[[VAL_7:.*]] = seq.compreg sym @p0_stage1_enable  %[[VAL_2]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_6]]  : i1
// CHECK:           %[[VAL_8:.*]] = hw.constant false
// CHECK:           %[[VAL_9:.*]] = seq.compreg sym @p0_stage2_enable  %[[VAL_7]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_8]]  : i1
// CHECK:           %[[VAL_10:.*]] = seq.compreg sym @p0_stage2_reg0 %[[VAL_5]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_11:.*]] = hw.constant false
// CHECK:           %[[VAL_12:.*]] = seq.compreg sym @p0_stage3_enable  %[[VAL_9]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_11]]  : i1
// CHECK:           %[[VAL_13:.*]] = seq.compreg sym @p0_stage3_reg0 %[[VAL_10]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_14:.*]] = hw.constant false
// CHECK:           %[[VAL_15:.*]] = seq.compreg sym @p0_stage4_enable  %[[VAL_12]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_14]]  : i1
...
// CHECK:           %[[VAL_6:.*]] = seq.compreg sym @p0_stage0_reg0 %[[VAL_5]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_7:.*]] = seq.compreg sym @p0_stage0_reg1 %[[VAL_0]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_8:.*]] = hw.constant false
// CHECK:           %[[VAL_9:.*]] = seq.compreg sym @p0_stage1_enable  %[[VAL_2]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_8]]  : i1
...
// CHECK:           %[[VAL_9:.*]] = seq.compreg sym @p0_stage1_enable  %[[VAL_2]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_8]]  : i1
// CHECK:           %[[VAL_10:.*]] = comb.add %[[VAL_6]], %[[VAL_7]] : i32
// CHECK:           %[[VAL_11:.*]] = seq.compreg sym @p0_stage1_reg0 %[[VAL_10]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_12:.*]] = seq.compreg sym @p0_stage1_reg1 %[[VAL_6]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_13:.*]] = hw.constant false
// CHECK:           %[[VAL_14:.*]] = seq.compreg sym @p0_stage2_enable  %[[VAL_9]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_13]]  : i1
// CHECK:           %[[VAL_15:.*]] = comb.mul %[[VAL_11]], %[[VAL_12]] : i32
// CHECK:           %[[VAL_16:.*]] = comb.sub %[[VAL_15]], %[[VAL_1]] : i32
// CHECK:           %[[VAL_17:.*]] = seq.compreg sym @p1_stage0_reg0 %[[VAL_16]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_18:.*]] = seq.compreg sym @p1_stage0_reg1 %[[VAL_15]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_19:.*]] = hw.constant false
// CHECK:           %[[VAL_20:.*]] = seq.compreg sym @p1_stage1_enable  %[[VAL_2]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_19]]  : i1
// CHECK:           %[[VAL_21:.*]] = comb.add %[[VAL_17]], %[[VAL_18]] : i32
// CHECK:           %[[VAL_22:.*]] = seq.compreg sym @p1_stage1_reg0 %[[VAL_21]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_23:.*]] = seq.compreg sym @p1_stage1_reg1 %[[VAL_17]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_24:.*]] = hw.constant false
// CHECK:           %[[VAL_25:.*]] = seq.compreg sym @p1_stage2_enable  %[[VAL_20]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_24]]  : i1
...
// CHECK:           %[[VAL_7:.*]] = seq.compreg sym @p0_stage0_reg0 %[[VAL_6]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_8:.*]] = hw.constant false
// CHECK:           %[[VAL_9:.*]] = seq.compreg sym @p0_stage1_enable  %[[VAL_2]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_8]]  : i1
// CHECK:           %[[VAL_10:.*]] = comb.add %[[VAL_7]], %[[VAL_1]] : i32
// CHECK:           %[[VAL_11:.*]] = seq.compreg sym @p0_stage1_reg0 %[[VAL_10]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_12:.*]] = hw.constant false
// CHECK:           %[[VAL_13:.*]] = seq.compreg sym @p0_stage2_enable  %[[VAL_9]] clock %[[CLOCK]] reset %[[VAL_4]], %[[VAL_12]]  : i1
...
// CHECK:           %[[VAL_8:.*]] = seq.compreg.ce %[[VAL_7]] clock %[[CLOCK]], %[[VAL_1]] reset %[[VAL_3]], %[[VAL_4]]  : i32
// CHECK:           sv.assign %[[VAL_5]], %[[VAL_8]] : i32
// CHECK:           %[[VAL_9:.*]] = seq.compreg sym @p0_stage0_reg0 %[[VAL_8]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_10:.*]] = hw.constant false
// CHECK:           %[[VAL_11:.*]] = seq.compreg sym @p0_stage1_enable  %[[VAL_1]] clock %[[CLOCK]] reset %[[VAL_3]], %[[VAL_10]]  : i1
// CHECK:           %[[VAL_12:.*]] = sv.wire : !hw.inout<i32>
// CHECK:           %[[VAL_13:.*]] = sv.read_inout %[[VAL_12]] : !hw.inout<i32>
// CHECK:           %[[VAL_14:.*]] = comb.add %[[VAL_13]], %[[VAL_9]] : i32
// CHECK:           %[[VAL_15:.*]] = seq.compreg.ce %[[VAL_14]] clock %[[CLOCK]], %[[VAL_11]] reset %[[VAL_3]], %[[VAL_4]]  : i32
// CHECK:           sv.assign %[[VAL_12]], %[[VAL_15]] : i32
// CHECK:           %[[VAL_16:.*]] = seq.compreg sym @p0_stage1_reg0 %[[VAL_15]] clock %[[CLOCK]] : i32
// CHECK:           %[[VAL_17:.*]] = hw.constant false
// CHECK:           %[[VAL_18:.*]] = seq.compreg sym @p0_stage2_enable  %[[VAL_11]] clock %[[CLOCK]] reset %[[VAL_3]], %[[VAL_17]]  : i1
// CHECK:           %[[VAL_19:.*]] = sv.wire : !hw.inout<i32>
// CHECK:           %[[VAL_20:.*]] = sv.read_inout %[[VAL_19]] : !hw.inout<i32>
// CHECK:           %[[VAL_21:.*]] = comb.add %[[VAL_20]], %[[VAL_16]] : i32
// CHECK:           %[[VAL_22:.*]] = seq.compreg.ce %[[VAL_21]] clock %[[CLOCK]], %[[VAL_18]] reset %[[VAL_3]], %[[VAL_4]]  : i32
...
hw.module @testControlUsage(in %arg0: i32, in %go : i1, in %clk: !seq.clock, in %rst: i1, out out0: i32) {
  %0:2 = pipeline.scheduled(%a0 : i32 = %arg0) clock(%clk) reset(%rst) go(%go) entryEn(%s0_enable) -> (out: i32) {
    ...
    %out = seq.compreg.ce %add0 clock %clk, %go reset %rst, %zero : i32
  ...
  ^bb1(%6: i32, %s1_enable: i1):
    ...
    %out1 = seq.compreg.ce %add1 clock %clk, %s1_enable reset %rst, %zero : i32
  ...
  ^bb2(%9 : i32, %s2_enable: i1):
    ...
    %out2 = seq.compreg.ce %add2 clock %clk, %s2_enable reset %rst, %zero : i32
...
// CHECK:           %[[VAL_8:.*]] = seq.compreg.ce sym @p0_stage0_reg0 %[[VAL_0]] clock %[[CLOCK]], %[[VAL_7]] : i32
// CHECK:           %[[VAL_9:.*]] = hw.constant false
// CHECK:           %[[VAL_10:.*]] = hw.constant true
// CHECK:           %[[VAL_11:.*]] = comb.xor %[[VAL_2]], %[[VAL_10]] : i1
// CHECK:           %[[VAL_12:.*]] = seq.compreg.ce sym @p0_stage1_enable %[[VAL_7]] clock %[[CLOCK]], %[[VAL_11]] reset %[[VAL_4]], %[[VAL_9]]  : i1
...
// CHECK:           %[[VAL_7:.*]] = comb.and %[[VAL_1]], %[[VAL_6]]
// CHECK:           %[[VAL_8:.*]] = seq.compreg.ce sym @MyPipeline_a0_s1 %[[VAL_0]] clock %[[CLOCK]], %[[VAL_7]] : i32
// CHECK:           %[[VAL_9:.*]] = hw.constant false
// CHECK:           %[[VAL_10:.*]] = seq.compreg sym @MyPipeline_stage1_enable  %[[VAL_7]] clock %[[CLOCK]] reset %[[VAL_3]], %[[VAL_9]]  : i1
// CHECK:           %[[VAL_11:.*]] = seq.compreg.ce sym @MyPipeline_a0_s2 %[[VAL_8]] clock %[[CLOCK]], %[[VAL_10]] : i32
// CHECK:           %[[VAL_12:.*]] = hw.constant false
// CHECK:           %[[VAL_13:.*]] = hw.constant true
// CHECK:           %[[VAL_14:.*]] = comb.xor %[[VAL_4]], %[[VAL_13]] : i1
// CHECK:           %[[VAL_15:.*]] = comb.or %[[VAL_10]], %[[VAL_14]] : i1
// CHECK:           %[[VAL_16:.*]] = seq.compreg.ce sym @MyPipeline_stage2_enable %[[VAL_10]] clock %[[CLOCK]], %[[VAL_15]] reset %[[VAL_3]], %[[VAL_12]]  : i1
...
// CHECK:           %[[VAL_21:.*]] = seq.compreg.ce sym @MyPipeline_a0_s3 %[[VAL_11]] clock %[[CLOCK]], %[[VAL_20]] : i32
...
// CHECK:           %[[VAL_26:.*]] = seq.compreg.ce sym @MyPipeline_stage3_enable %[[VAL_20]] clock %[[CLOCK]], %[[VAL_25]] reset %[[VAL_3]], %[[VAL_22]]  : i1
...
// CHECK-NEXT:    %stage0_reg0 = seq.compreg sym @stage0_reg0 %arg0 clock %clk : i1
// CHECK-NEXT:    %false = hw.constant false
// CHECK-NEXT:    %stage1_enable = seq.compreg sym @stage1_enable  %arg0 clock %clk reset %rst, %false  : i1
