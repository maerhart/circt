...
// CHECK:           %[[VAL_12:.*]] = seq.compreg sym @valid0_reg %[[VAL_13:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_18]] = seq.compreg sym @data0_reg %[[VAL_17]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_10]]  : i0
// CHECK:           %[[VAL_19:.*]] = seq.compreg sym @ready0_reg %[[VAL_20:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_27:.*]] = seq.compreg sym @ctrl_data0_reg %[[VAL_28:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_10]]  : i0
...
// CHECK:           %[[VAL_32:.*]] = seq.compreg sym @valid1_reg %[[VAL_33:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_37]] = seq.compreg sym @data1_reg %[[VAL_36]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_31]]  : i0
// CHECK:           %[[VAL_38:.*]] = seq.compreg sym @ready1_reg %[[VAL_39:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_46:.*]] = seq.compreg sym @ctrl_data1_reg %[[VAL_47:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_31]]  : i0
...
// CHECK:           %[[VAL_51:.*]] = seq.compreg sym @valid2_reg %[[VAL_52:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_56]] = seq.compreg sym @data2_reg %[[VAL_55]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_50]]  : i0
// CHECK:           %[[VAL_57:.*]] = seq.compreg sym @ready2_reg %[[VAL_58:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_63:.*]] = seq.compreg sym @ctrl_data2_reg %[[VAL_64:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_50]]  : i0
...
// CHECK:           %[[VAL_18]] = seq.compreg sym @data0_reg %[[VAL_17]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_10]]  : i64
// CHECK:           %[[VAL_19:.*]] = seq.compreg sym @ready0_reg %[[VAL_20:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
// CHECK:           %[[VAL_21:.*]] = comb.mux %[[VAL_19]], %[[VAL_19]], %[[VAL_12]] : i1
// CHECK:           %[[VAL_16]] = comb.xor %[[VAL_19]], %[[VAL_14]] : i1
// CHECK:           %[[VAL_22:.*]] = comb.xor %[[VAL_23:.*]], %[[VAL_14]] : i1
...
// CHECK:           %[[VAL_26:.*]] = comb.and %[[VAL_23]], %[[VAL_19]] : i1
// CHECK:           %[[VAL_20]] = comb.mux %[[VAL_26]], %[[VAL_11]], %[[VAL_25]] : i1
// CHECK:           %[[VAL_27:.*]] = seq.compreg sym @ctrl_data0_reg %[[VAL_28:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_10]]  : i64
...
// CHECK:           %[[VAL_31:.*]] = seq.compreg sym @valid1_reg %[[VAL_32:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_36]] = seq.compreg sym @data1_reg %[[VAL_35]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_10]]  : i64
// CHECK:           %[[VAL_37:.*]] = seq.compreg sym @ready1_reg %[[VAL_38:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_11]]  : i1
...
// CHECK:           %[[VAL_43:.*]] = seq.compreg sym @ctrl_data1_reg %[[VAL_44:.*]] clock %[[VAL_1]] reset %[[VAL_2]], %[[VAL_10]]  : i64
...
// CHECK:         %data0_reg = seq.compreg sym @data0_reg %4 clock %clock reset %reset, %[[CZERO]]  : !hw.struct<field0: i32, field1: i32>
