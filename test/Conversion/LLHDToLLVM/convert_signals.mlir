...
// CHECK:           %[[VAL_6:.*]] = llvm.mlir.constant(dense<[1, 0, 0]> : vector<3xi32>) : !llvm<"[3 x i32]">
...
// CHECK:           %[[VAL_11:.*]] = llvm.extractvalue %[[VAL_6]][0 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_12:.*]] = llvm.extractvalue %[[VAL_6]][1 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_13:.*]] = llvm.extractvalue %[[VAL_6]][2 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_14:.*]] = llvm.call @drive_signal(%[[VAL_0]], %[[VAL_4]], %[[VAL_10]], %[[VAL_7]], %[[VAL_11]], %[[VAL_12]], %[[VAL_13]]) : (!llvm<"i8*">, !llvm<"{ i8*, i64, i64, i64 }*">, !llvm<"i8*">, !llvm.i64, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm.void
// CHECK:           llvm.return
// CHECK:         }
...
// CHECK:           %[[VAL_13:.*]] = llvm.extractvalue %[[VAL_6]][0 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_14:.*]] = llvm.extractvalue %[[VAL_6]][1 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_15:.*]] = llvm.extractvalue %[[VAL_6]][2 : i32] : !llvm<"[3 x i32]">
// CHECK:           %[[VAL_16:.*]] = llvm.call @drive_signal(%[[VAL_0]], %[[VAL_4]], %[[VAL_12]], %[[VAL_9]], %[[VAL_13]], %[[VAL_14]], %[[VAL_15]]) : (!llvm<"i8*">, !llvm<"{ i8*, i64, i64, i64 }*">, !llvm<"i8*">, !llvm.i64, !llvm.i32, !llvm.i32, !llvm.i32) -> !llvm.void
// CHECK:           llvm.br ^bb2
// CHECK:         ^bb2:
// CHECK:           llvm.return
// CHECK:         }
