...
// CHECK:           %[[VAL_8:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_9:.*]] = llvm.alloca %[[VAL_8]] x !llvm.i1 {alignment = 4 : i64} : (!llvm.i32) -> !llvm<"i1*">
// CHECK:           llvm.store %[[VAL_5]], %[[VAL_9]] : !llvm<"i1*">
// CHECK:           %[[VAL_10:.*]] = llvm.bitcast %[[VAL_9]] : !llvm<"i1*"> to !llvm<"i8*">
// CHECK:           %[[VAL_11:.*]] = llvm.extractvalue %[[VAL_6]][0 : i32] : !llvm<"[3 x i64]">
// CHECK:           %[[VAL_12:.*]] = llvm.extractvalue %[[VAL_6]][1 : i32] : !llvm<"[3 x i64]">
// CHECK:           %[[VAL_13:.*]] = llvm.extractvalue %[[VAL_6]][2 : i32] : !llvm<"[3 x i64]">
// CHECK:           %[[VAL_14:.*]] = llvm.call @drive_signal(%[[VAL_0]], %[[VAL_4]], %[[VAL_10]], %[[VAL_7]], %[[VAL_11]], %[[VAL_12]], %[[VAL_13]]) : (!llvm<"i8*">, !llvm<"{ i8*, i64, i64, i64 }*">, !llvm<"i8*">, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64) -> !llvm.void
=======
// CHECK:           %[[VAL_5:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_6:.*]] = llvm.getelementptr %[[VAL_2]]{{\[}}%[[VAL_5]]] : (!llvm<"{ i8*, i64, i64, i64 }*">, !llvm.i32) -> !llvm<"{ i8*, i64, i64, i64 }*">
...
// CHECK:           %[[VAL_23:.*]] = llvm.mlir.constant(8 : i64) : !llvm.i64
// CHECK:           %[[VAL_24:.*]] = llvm.mlir.null : !llvm<"[3 x i5]*">
// CHECK:           %[[VAL_25:.*]] = llvm.getelementptr %[[VAL_24]]{{\[}}%[[VAL_22]]] : (!llvm<"[3 x i5]*">, !llvm.i32) -> !llvm<"[3 x i5]*">
// CHECK:           %[[VAL_26:.*]] = llvm.ptrtoint %[[VAL_25]] : !llvm<"[3 x i5]*"> to !llvm.i64
// CHECK:           %[[VAL_27:.*]] = llvm.mul %[[VAL_26]], %[[VAL_23]] : !llvm.i64
// CHECK:           %[[VAL_28:.*]] = llvm.mlir.constant(1 : i32) : !llvm.i32
// CHECK:           %[[VAL_29:.*]] = llvm.alloca %[[VAL_28]] x !llvm<"[3 x i5]"> {alignment = 4 : i64} : (!llvm.i32) -> !llvm<"[3 x i5]*">
// CHECK:           llvm.store %[[VAL_12]], %[[VAL_29]] : !llvm<"[3 x i5]*">
// CHECK:           %[[VAL_30:.*]] = llvm.bitcast %[[VAL_29]] : !llvm<"[3 x i5]*"> to !llvm<"i8*">
// CHECK:           %[[VAL_31:.*]] = llvm.extractvalue %[[VAL_13]][0 : i32] : !llvm<"[3 x i64]">
// CHECK:           %[[VAL_32:.*]] = llvm.extractvalue %[[VAL_13]][1 : i32] : !llvm<"[3 x i64]">
// CHECK:           %[[VAL_33:.*]] = llvm.extractvalue %[[VAL_13]][2 : i32] : !llvm<"[3 x i64]">
// CHECK:           %[[VAL_34:.*]] = llvm.call @drive_signal(%[[VAL_0]], %[[VAL_6]], %[[VAL_30]], %[[VAL_27]], %[[VAL_31]], %[[VAL_32]], %[[VAL_33]]) : (!llvm<"i8*">, !llvm<"{ i8*, i64, i64, i64 }*">, !llvm<"i8*">, !llvm.i64, !llvm.i64, !llvm.i64, !llvm.i64) -> !llvm.void
>>>>>>> llhd-sim-trace
// CHECK:           llvm.return
// CHECK:         }
