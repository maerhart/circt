...
// CHECK:           %[[VAL_13:.*]] = llvm.extractvalue %[[VAL_3]][0 : i32] : !llvm<"[2 x i5]">
// CHECK:           %[[VAL_14:.*]] = llvm.insertvalue %[[VAL_13]], %[[VAL_2]][1 : i32] : !llvm<"[4 x i5]">
// CHECK:           %[[VAL_15:.*]] = llvm.extractvalue %[[VAL_3]][1 : i32] : !llvm<"[2 x i5]">
// CHECK:           %[[VAL_16:.*]] = llvm.insertvalue %[[VAL_15]], %[[VAL_14]][2 : i32] : !llvm<"[4 x i5]">
// CHECK:           llvm.return
// CHECK:         }
...
// CHECK-SAME:                                      %[[VAL_1:.*]]: !llvm<"[4 x i5]">,
// CHECK-SAME:                                      %[[VAL_2:.*]]: !llvm<"{ i4, i5, i6 }">) {
// CHECK:           %[[VAL_3:.*]] = llvm.insertvalue %[[VAL_0]], %[[VAL_1]][0 : index] : !llvm<"[4 x i5]">
// CHECK:           %[[VAL_4:.*]] = llvm.insertvalue %[[VAL_0]], %[[VAL_2]][1 : index] : !llvm<"{ i4, i5, i6 }">
// CHECK:           llvm.return
// CHECK:         }
