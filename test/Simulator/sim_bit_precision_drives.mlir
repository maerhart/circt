...
llhd.entity @root () -> () {
    ...
    %e0 = llhd.exts %s0, 0, 16 : !llhd.sig<i32> to !llhd.sig<i16>
    %e1 = llhd.exts %s1, 4, 8 : !llhd.sig<i32> to !llhd.sig<i8>
    %e2 = llhd.exts %s2, 0, 1 : !llhd.sig<i32> to !llhd.sig<i1>
    %e3 = llhd.exts %s2, 1, 1 : !llhd.sig<i32> to !llhd.sig<i1>
